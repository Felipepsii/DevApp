...
public class Program {
	...
	double[] nf = new double [5];
		...
		for (int i = 0; i < 5; i++) {
			...
			nf[i] = calcular(n1[i], n2[i], n3[i], n4[i], n5[i]);
	...
	public static double calcular(double n1,double n2, double n3, double n4, double n5	) {
	
		double vlr = ((n1 * 0.05) + (n2 * 0.05) + (n3 * 0.2) + (n4 * 0.2) + (n5 * 0.5));
		return vlr;
	}
